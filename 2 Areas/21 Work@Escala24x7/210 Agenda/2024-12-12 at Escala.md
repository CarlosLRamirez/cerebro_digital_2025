...
modified: '"2025-01-08 11:55", "3tc/G1T+6"'
date: 2024-12-12
type:
  - minuta
aliases: 
...
- [ ] Seguimiento de Ventana de AppRuteo pendiente  #followup #id10854
	- 8/Ene/25: envie un correo a Cempro
...
- [x] Despliegue en ambiente de Laboratorio de Whitelist #closed #id11065
...
- [x] Nelson esta resoliviendo unos temas de la redacción de los correos #closed #id11065
...
- [ ] pruebas de conectividad en ambientes bajos (Costa Rica) #id11206 #followup
	...
	- David Chaparro sugirió tomar estos cambios como soporte a la aplicación y no abrir un proyecto interno para el mismo.
	- Fernando quedo de llevarse el punto para la próxima reunión como iniciar la integración y pruebas del ambiente de Costa Rica 
	- 8/ene/25: Seguimos esperando que esté lista la imagen de redhat para volver a desplegar y hacer las pruebas correspondientes
...
- [ ] Seguimiento a despliegue de Seguridad Perimetral #followup #id11221
	- 8/Ene: La ultima actualizacion de David Chaparro es que estan desplegando los Panorama, esperan tenerlo listo esta semana
- [ ] Seguimiento a imagen de Redhat #followup #id11221 #id11206
	- 8/Ene/25: según la ultima actualización de Edwin Perillla este viernes esperan hacer una prueba crucial para certificar la imagen
