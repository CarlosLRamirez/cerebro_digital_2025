...
modified: '"2024-12-13 16:50", "5tc/G12T+6"'
date: 2024-12-13
type:
  - daily-note-escala
aliases: 
...
```dataview
TASK WHERE due <= date(today) AND !completed AND !contains(tags, "#followup") AND ( contains(tags, "#id") OR contains(tags, "#PMO") OR contains(tags, "#Escala24x7") )
```
